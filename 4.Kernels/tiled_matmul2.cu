/*
A kernel that performs tiled matrix multiplication
...
{
    /*
    defining shared memory variants of matrices M and N
    */
    ...
    // looping over M and N tiles required to compute P element
    float Pvalue = 0.0f;
    ...
    {
        // collaboratively loading M tile into shared memory
        ...
        // collaboratively loading N tile into shared memory
