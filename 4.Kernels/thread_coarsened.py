...
EXTENSION_NAME = "thread_coarsened_matmul_extension"
CUDA_FILE = "thread_coarsened.cu"
...
def compile_extension(verbose=False):
    ...
    return load_inline(
        ...
        functions=["thread_coarsened_matmul"],
        with_cuda=True,
        extra_cflags=["-O2"],
...
def thread_coarsened_matmul(m, n, ext=None):
    ext = ext or compile_extension()
    return ext.thread_coarsened_matmul(m.contiguous(), n.contiguous())
...
def main():
    ...
    result = thread_coarsened_matmul(m, n, ext)
