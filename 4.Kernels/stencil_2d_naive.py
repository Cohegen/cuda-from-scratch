...
EXTENSION_NAME = "stencil_2d_naive_extension"
CUDA_FILE = "stencil_2d_naive.cu"
...
def stencil_2d_naive(input_tensor, ext=None):
    ext = ext or compile_extension()
    width = input_tensor.size(0)
    output = torch.empty_like(input_tensor)
    ext.stencil_2d_cuda(input_tensor.contiguous(), output, width)
    return output
